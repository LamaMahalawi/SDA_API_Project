package Tests.Morning_Class.JsonNode;
...
public class C26_ObjectMapperNestedPojo extends BookersBaseURL {
    ...
    void objectMapperNestedPojoTest() {
        ...
        //Prepare the payload
        BookingPojo payload = convertJsonToJava(BOOKING_JSON, BookingPojo.class);
